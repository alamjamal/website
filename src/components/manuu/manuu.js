      ...
      <div className="main-div">
        <div className="manuu-div">
          ...
          <p className="about-manuu">
            ...
            Accreditation Council (NAAC), has awarded an <b> ‘A+’ </b>grade to
            the University.{" "}
          </p>
        </div>
        ...
        <div className="dept-div">
          ...
          <p className="about-dept">
            Department of Computer Science &amp; Information Technology
            (CS&amp;IT) under the ‘School of Technology’ was established in
            2006. The department has state-of-the-art ICT infrastructure . At
            present, the department is offering B.Tech, M.Tech, MCA, and PhD
            programmes in Computer Science and Information Technology. All these
            programs are approved by All India Council for Technical Education
            (AICTE). Currently, there are 25 faculty members working in the
            Department of CS&amp;IT conducting teaching and research under
            various areas of CS/IT. The Department of CS&amp;IT has focused on
            research in various cutting-edge areas such as machine translation,
            adaptive systems, personalized learning, bioinformatics, road
            dynamics, computer vision, web semantics, disease prediction, smart
